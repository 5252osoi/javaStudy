...
public class T04_CardLayout4 extends JFrame{
	...
	public T04_CardLayout4() {
		...
		btn1.setIcon(new ImageIcon(getClass().getResource("./images/11.png")));
		btn2.setIcon(new ImageIcon("./images/12.png"));
		btn3.setIcon(new ImageIcon("./images/13.png"));
		btn4.setIcon(new ImageIcon("./images/14.png"));
