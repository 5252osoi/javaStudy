...
//				JOptionPane.showMessageDialog(null, "입력버튼");
//			}
//		});
//		//수정
...
//		});
		ActionListener listener = new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				if(btnInput.equals(e.getSource()))JOptionPane.showMessageDialog(null, "입력버튼");
				else if(btnUpdate.equals(e.getSource()))JOptionPane.showMessageDialog(null, "수정버튼");
				else if(btnSearch.equals(e.getSource()))JOptionPane.showMessageDialog(null, "개별조회버튼");
				else if(btnList.equals(e.getSource()))JOptionPane.showMessageDialog(null, "전체조회버튼");
				else if(btnDelete.equals(e.getSource()))JOptionPane.showMessageDialog(null, "삭제버튼");
				else if(btnExit.equals(e.getSource())) {
					JOptionPane.showMessageDialog(null, "종료버튼");
					System.exit(0);
				}
